...
<!DOCTYPE html>        
            ...
            while($row1 = $result1->fetch_assoc())
            {
                $ht.='
                        <div class="col-sm-4 itemsimage">
                                <image class="img-responsive" style="display:block; margin-left:auto; margin-right:auto;"  src="images/'.$row1["image"].'" width="300px;" >
                                <div class="caption">
                                    <h2>'.$row1["brand"].'</h2>
                                    <h4>'.$row1["caption"].'</h4>
                                    <h5>$'.$row1["price"].'</h5>
    ...
    <body>
        ...
        <center>
        <div class="content">
            <center><div class="banner-image-watch">
